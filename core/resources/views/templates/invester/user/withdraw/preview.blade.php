                    ...
                    <uni-view data-v-24d80312="" class="container">
                        <uni-view data-v-c4b04b80="" data-v-24d80312="" class="u-navbar">
                            ...
                            <uni-view data-v-c4b04b80="" class="u-navbar--fixed">
                                ...
                                <uni-view data-v-c4b04b80="" class="u-navbar__content" style="height: 44px; background-color: rgb(255, 255, 255);">
                                    ...
                                    <uni-text data-v-c4b04b80="" class="u-line-1 u-navbar__content__title" style="width: 200px;"><span>Withdraw Perview</span></uni-text>
                        ...
                        <uni-view data-v-24d80312="" class="panel">
                            ...
                            <uni-view data-v-18037164="" data-v-24d80312="" class="panel_t" style="">
                                <uni-view data-v-18037164="" class="panel_t__desc">Bank Name</uni-view>
                                        ...
                                        <uni-view data-v-0132f082="" class="uni-select round">
                                            <uni-view data-v-0132f082="" class="uni-select__input-box">
                                                <uni-view data-v-0132f082="" class="uni-select__input-text uni-select__input-placeholder">
                                                    <input class="uni-input-input" placeholder="Bank Name" name="bank_name">
                                ...
                                <uni-view data-v-18037164="" class="panel_t__desc">
                                    <uni-text data-v-18037164="" class="t1"><span>Account Name</span></uni-text>
                                </uni-view>
                                <uni-view data-v-0132f082="" data-v-18037164="" class="uni-stat__select">
                                    <!---->
                                    <uni-view data-v-0132f082="" class="uni-stat-box">
                                        <uni-view data-v-0132f082="" class="uni-select round">
                                            <uni-view data-v-0132f082="" class="uni-select__input-box">
                                 <input class="uni-input-input" placeholder="Account Name" name="account_name">
                                         
                                                
                                                <uni-image data-v-0132f082="" class="uni-select__input-icon bottom">
                                                    <div style="background-image: url(&quot;/static/triggle_icon.webp&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;">
                                ...
                                <uni-view data-v-18037164="" class="panel_t__desc">
                                    <uni-text data-v-18037164="" class="t1"><span>Account Number</span></uni-text>
                                </uni-view>
                                <uni-view data-v-0132f082="" data-v-18037164="" class="uni-stat__select">
                                    <!---->
                                    <uni-view data-v-0132f082="" class="uni-stat-box">
                                        <uni-view data-v-0132f082="" class="uni-select round">
                                            <uni-view data-v-0132f082="" class="uni-select__input-box">
                                 <input class="uni-input-input" placeholder="Account Number" name="account_number">
                                ...
                                <button data-v-50bed489="" data-v-18037164="" class="u-button u-reset-button confirm-btn u-button--circle u-button--normal" app-parameter="" send-message-title="" send-message-path="" lang="en" data-name=""
                                    ...
                                    <uni-text data-v-50bed489="" class="u-button__text" style="font-size: 14px;"><span>Confirm</span></uni-text>
                                         ...
                                         <uni-view data-v-41f87b2a="" class="info__tip">Note: Before recharging, be sure to check all entered recharge addresses carefully to ensure the address is correct. If incorrect, the recharged funds will not be credited</uni-view>
                                <uni-view data-v-41f87b2a="" class="info__tip"
                                    style="margin-top: 6px;">Minimum recharge amount 1{{ $general->cur_text }}/1{{ $general->cur_text }}</uni-view>
